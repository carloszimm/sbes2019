...
function anyCepjsRx_minInterval(total){
    var count = 0;
	async.whilst(
...
function anyCepjsRx_maxInterval(total){
    var count = 0;
	async.whilst(
		function() { return count < total; },
		function(callback) {
...
function anyCepjsMost_minInterval(total){
    var count = 0;
	async.whilst(
		function() { return count < total; },
		function(callback) {
...
function anyCepjsMost_maxInterval(total){
    var count = 0;
	async.whilst(
		function() { return count < total; },
		function(callback) {
