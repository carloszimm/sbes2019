...
function alwaysCepjsRx_minInterval(total){
    var count = 0;
	async.whilst(
...
function alwaysCepjsRx_maxInterval(total){
    var count = 0;
	async.whilst(
		function() { return count < total; },
		function(callback) {
...
function alwaysCepjsMost_minInterval(total){
    var count = 0;
	async.whilst(
		function() { return count < total; },
		function(callback) {
...
function alwaysCepjsMost_maxInterval(total){
    var count = 0;
	async.whilst(
		function() { return count < total; },
		function(callback) {
